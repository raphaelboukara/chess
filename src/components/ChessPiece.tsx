...
const ChessPiece: React.FC<ChessPieceProps> = ({ piece, size = 45, className = '' }) => {
    switch (piece) {
        case 'wp': // White Pawn
            return (
                <svg
        ...
        default:
            // Fallback for any unrecognized piece codes
            console.warn(`Unknown piece code: ${piece}`);
            return (
                <svg width={size} height={size} viewBox="0 0 100 100" className={className}>
                    <circle cx="50" cy="50" r="20" fill="#ff0000" stroke="#000000" strokeWidth="2" />
                    <text x="50" y="55" textAnchor="middle" fill="#ffffff" fontSize="12">{piece}</text>
                </svg>
            );
    };
};
